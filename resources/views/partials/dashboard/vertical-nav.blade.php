<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-project_detail" role="button" aria-expanded="false" aria-controls="sidebar-project_detail">
            ...
            <span class="item-name">Project Details</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <ul class="sub-nav collapse" id="sidebar-project_detail" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('project.detail.show', 1))}}" href="{{route('project.detail.show', 1)}}">
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Project detail show</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('project.detail.create'))}}" href="{{route('project.detail.create')}}">
                    ...
                    <i class="sidenav-mini-icon"> E </i>
                    <span class="item-name">Edit Project Detail</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-bike" role="button" aria-expanded="false" aria-controls="sidebar-bike">
            ...
            <span class="item-name">Bike Calculator</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <ul class="sub-nav collapse" id="sidebar-bike" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('bike.form', 1))}}" href="{{route('bike.form', 1)}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Bike Form</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('bike.check'))}}" href="{{route('bike.check')}}">
                    ...
                    <i class="sidenav-mini-icon"> E </i>
                    <span class="item-name">Bike Check</span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link " data-bs-toggle="collapse" href="#sidebar-solar" role="button" aria-expanded="false" aria-controls="sidebar-solar">
            ...
            <span class="item-name">Solar Calculator</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <ul class="sub-nav collapse" id="sidebar-solar" data-bs-parent="#sidebar">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('solar.calculate.index'))}}" href="{{route('solar.calculate.index')}}">
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Solar List</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('solar.calculate.upload'))}}" href="{{route('solar.calculate.upload')}}">
                    ...
                    <i class="sidenav-mini-icon"> U </i>
                    <span class="item-name">Solar Upload</span>
                </a>
            </li>
        </ul>
    </li>
